...
const StoryCard: React.FC<StoryCardProps> = ({ story, onSelect, onEdit, onDelete }) => (
  <div data-testid="story-card" className="group relative bg-bg-sidebar border border-border rounded-xl overflow-hidden transition-all duration-150 hover:border-zinc-300 dark:hover:border-zinc-600 hover:shadow-md">
